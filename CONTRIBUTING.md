...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/Exception-Class).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Exception-Class)
or [via email](bug-exception-class@rt.cpan.org.
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.54.
